...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container">
        <button class="addEmp layui-btn layui-btn-sm" lay-event="add">添加客户</button>
    </div>
</script>
    ...
    layui.use('table', function(){
        ...
        table.on('tool(customerList)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'detail'){
                ...
                layer.confirm('确定要删除客户【'+data.cusName+"】信息吗？", function(index){
                    //向服务端发送删除指令
                    $.ajax({
                ...
                layer.open({
                    type: 2
                    ,title: '修改商品信息'
                    ,content: 'customer/toModifyCustomer/'+data.cusId
                    ,maxmin: true
                    ,area: ['700px', '400px']
                    ,btn: ['确定', '取消']
                    ,yes: function(index, layero){
